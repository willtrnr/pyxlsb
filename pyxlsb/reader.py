...
class BIFF12Reader(object):
    handlers = {
        ...
        biff12.FORMULA_STRING:  FormulaCellHandler(),
        biff12.FORMULA_FLOAT:   FormulaCellHandler(),
        biff12.FORMULA_BOOL:    FormulaCellHandler(),
        biff12.FORMULA_BOOLERR: FormulaCellHandler(),
    ...
    def next(self):
        ...
        while ret is None:
            ...
            ret = self.handlers.get(recid, self.default_handler).read(RecordReader(recdata), recid, reclen)
            if self._debug:
