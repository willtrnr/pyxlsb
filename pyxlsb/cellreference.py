...
class CellReference(object):
    ...
    def __eq__(self, other):
        return (
            ...
            and self.row_rel == other.row_rel
            and self.col_rel == other.col_rel
        )

    def __repr__(self):
        return "CellReference(row={}, col={}, row_rel={}, col_rel={})".format(
            self.row, self.col, self.row_rel, self.col_rel
        )
